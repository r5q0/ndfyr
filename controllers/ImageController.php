...
class ImageController
{
    ...
    public static function init()
    {
        ...
        self::$samConfig = [
            ...
            'dino_text_prompt' => 'clothing. straps. bikini. clothes. tops. pants. bathing suit. clothes. bra. panties. ',
        ...
        self::$img2imgConfig = [
            ...
            "alwayson_scripts" => array(
                "Dynamic Thresholding (CFG Scale Fix)" => array(
